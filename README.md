...
- **Centralisation** : Regrouper les offres et les entreprises partenaires.

- **Suivi** : Permettre un pilotage précis des candidatures (côté étudiant et administrateur).
...
- **Pilote** : Gestion des promotions et suivi des recherches d'étudiants.

- **Étudiant** : Recherche d'offres, postulation et gestion de wishlist.
...
- **Wish-list** : Système de sauvegarde des offres favorites.

- **Candidature** : Système de dépôt de dossier directement sur la plateforme.

- **Responsive Design** : Expérience fluide et adaptée sur mobile, tablette et desktop.
